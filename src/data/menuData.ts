...
export const menuData: I0LinkItem[] = [
  {
    ...
    link: "obf4m08gkx",
    status: "Prototype",
    description: "Hiển thị tổng quan các số liệu và hoạt động chính của hệ thống.",
  },
  {
    ...
    links: [
      {
        ...
        link: "core26965",
        status: "Default",
        description: "Quản lý và tra cứu các văn bản, quy định nội bộ của tổ chức.",
      },
      {
        pageId: 22,
        ...
        link: "core27311",
        status: "Default",
        description: "Theo dõi và cập nhật quy trình xử lý công việc trong tổ chức.",
      },
      {
        pageId: 23,
        name: "Form templates",
        ...
        link: "core12196",
        status: "Default",
        description: "Lưu trữ và quản lý các biểu mẫu sử dụng trong các quy trình.",
      },
    ],
  },
    ...
    links: [
      {
        ...
        link: "mc1b1zpbg6",
        status: "Prototype",
        description: "Danh sách các bộ tiêu chuẩn áp dụng trong hoạt động kiểm định.",
      },
      {
        pageId: 32,
        ...
        link: "po2maj8sm7",
        status: "Prototype",
        description: "Xây dựng và quản lý cấu trúc chi tiết của từng bộ tiêu chuẩn.",
      },
    ],
  },

  {
    ...
    links: [
      ...
      },
      {
        ...
        link: "grtzbp3rjk",
        status: "Prototype",
        description: "Tạo và quản lý các nhiệm vụ báo cáo định kỳ theo mốc thời gian.",
      },
    ],
  },
    ...
    links: [
      {
        ...
        link: "79t4hwd85i",
        status: "Prototype",
        description: "Soạn thảo nội dung báo cáo tự đánh giá theo từng mốc chuẩn.",
      },
      {
        pageId: 62,
        name: "Summary report",
      ...
      },
      {
        ...
        link: "k25w91d9v2",
        status: "Prototype",
        description: "Xuất file báo cáo tự đánh giá để phục vụ các công tác liên quan.",
      },
    ],
  },

  {
    ...
    links: [
      ...
      },
      {
        ...
        link: "xwuj3dvbgs",
        status: "Prototype",
        description: "Lập kế hoạch hành động khắc phục và cải tiến sau đánh giá.",
      },
      {
        pageId: 73,
    ...
    links: [
      {
        ...
        link: "k683h5xrg3",
        status: "Prototype",
        description: "Cài đặt và cập nhật thông tin của đơn vị chủ quản hệ thống.",
      },
      {
        pageId: 1000,
        name: "",
