...
export const menuData_Program: I0LinkItem[] = [
...

  {
    ...
    links: [
      { pageId: 21, name: "Organizational regulations", label: "Văn bản – Quy định tổ chức", link: "core26965", status: "Default", description: "Quản lý và tra cứu các văn bản, quy định nội bộ của tổ chức.", },
      { pageId: 22, name: "Workflow process", label: "Quy trình xử lý công việc", link: "core27311", status: "Default", description: "Theo dõi và cập nhật quy trình xử lý công việc trong tổ chức.", },
      { pageId: 23, name: "Form templates", label: "Tài liệu biểu mẫu", link: "core12196", status: "Default", description: "Lưu trữ và quản lý các biểu mẫu sử dụng trong các quy trình.", },
    ],
  },

  {
    ...
    links: [
      ...
      { pageId: 32, name: "Configuration criteria indicators requirements", label: "Cấu hình Tiêu chí, Chỉ báo, Yêu cầu", link: "standards-config", status: "Prototype", },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Quản lý Bảng Tổng hợp Kết quả Tự đánh giá và Đánh giá ngoài (Biểu 11)", name: "Self And External Evaluation Results", link: "self-and-external-evaluation-results-11", status: "Prototype", description: "" },
  ...
  //     { pageId: 42, name: "Preparation roadmap", label: "Lộ trình chuẩn bị", link: "vpouokrvmt", status: "Prototype", description: "Lập kế hoạch và theo dõi lộ trình chuẩn bị cho kiểm định.", },
  //     { pageId: 43, name: "Establish Council", label: "Thành lập hội đồng", link: "establish-council", status: "Prototype", description: "Thành lập hội đồng kiểm định theo quy định.", },
  //     { pageId: 44, name: "Self assessment plan", label: "Kế hoạch tự đánh giá", link: "self-assessment-plan", status: "Prototype", description: "Lập kế hoạch tự đánh giá theo quy định.", },
  //     { pageId: 45, name: "Analysis form", label: "Phiếu phân tích tiêu chí", link: "analysis-form", status: "Prototype", description: "Phiếu phân tích tiêu chí theo quy định.", },
  //     { pageId: 43, name: "Report management", label: "Quản lý kỳ báo cáo", link: "vrdjnzpfmc", status: "Prototype", description: "Tổng hợp và quản lý thông tin kỳ báo cáo kiểm định.", },
  //     { pageId: 47, name: "Assignment", label: "Phân công phụ trách mốc chuẩn", link: "raolvysdbf", status: "Prototype", description: "Phân công cán bộ phụ trách từng mốc chuẩn trong tiêu chuẩn.", },
  //     { pageId: 48, name: "Recurring tasks", label: "Thiết lập nhiệm vụ báo cáo định kỳ", link: "grtzbp3rjk", status: "Prototype", description: "Tạo và quản lý các nhiệm vụ báo cáo định kỳ theo mốc thời gian." },
  //   ],
  // },
  ...
  //   links: [
  //     { pageId: 51, name: "Evidence repository", label: "Kho minh chứng", link: "x19IQVXguk", status: "Prototype", description: "Lưu trữ và tra cứu minh chứng phục vụ công tác đánh giá.", },
  //     { pageId: 52, name: "Evidence management", label: "Quản lý minh chứng", link: "evidence-management", status: "Prototype", description: "Lưu trữ và tra cứu minh chứng phục vụ công tác đánh giá.", }
  //   ],
  // },
  ...
  //   links: [
  //     { pageId: 61, name: "Draft report", label: "Soạn nội dung báo cáo", link: "79t4hwd85i", status: "Prototype", description: "Soạn thảo nội dung báo cáo tự đánh giá theo từng mốc chuẩn.", },
  //     { pageId: 62, name: "Summary report", label: "Tổng hợp báo cáo mốc chuẩn", link: "o4e65ehgty", status: "Prototype", description: "Tổng hợp các nội dung đã soạn thảo theo từng mốc chuẩn.", },
  //     { pageId: 63, name: "Export report", label: "Xuất báo cáo tự đánh giá", link: "k25w91d9v2", status: "Prototype", description: "Xuất file báo cáo tự đánh giá để phục vụ các công tác liên quan.", },
  //   ],
  // },
  ...
  //   links: [
  //     { pageId: 71, name: "Evaluation result", label: "Ghi nhận kết quả đánh giá", link: "vcd16qt9lf", status: "Prototype", description: "Nhập và lưu trữ kết quả đánh giá từ các đợt kiểm định.", },
  //     { pageId: 72, name: "Improvement plan", label: "Kế hoạch khắc phục/ cải tiến", link: "xwuj3dvbgs", status: "Prototype", description: "Lập kế hoạch hành động khắc phục và cải tiến sau đánh giá.", },
  //     { pageId: 73, name: "Monitoring improvements", label: "Theo dõi thực hiện khắc phục/ cải tiến", link: "pjbnqwljej", status: "Prototype", description: "Theo dõi tiến độ và kết quả thực hiện kế hoạch cải tiến.", },
  //   ],
  // },
  ...
  //     { pageId: 1, name: "List of evidence types", label: "Danh mục loại minh chứng", link: "4iahruyrpf", status: "Prototype" },
  //     { pageId: 1, name: "Rating scale list", label: "Danh mục thang đánh giá", link: "4ozfpuyh8g", status: "Prototype" },
  ...
  //     { pageId: 1006, name: "", label: "Danh mục bộ đếm", link: "6j8jkftgnc", status: "Prototype", description: "Quản lý các bộ đếm phục vụ đánh số văn bản, nhiệm vụ,...", },
  //   ],
  // },
];
