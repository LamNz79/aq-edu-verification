...
import ImprovementProgressTrackingExternal from "./ImprovementReportExportExternal";
import { IImprovementReportExportViewModel } from "./interface";
import ImprovementProgressTrackingAssessment from "./ImprovementReportExportAssessment";
...
export default function ImprovementReportExportTable() {
  const ExternalReviewInputData = useQuery({
    queryKey: ["improvement-report-export"],
    queryFn: () => {
      return mockData;
    },
  });

  const columns = useMemo<MRT_ColumnDef<IImprovementReportExportViewModel>[]>(
    () => [
      {
...
const mockData: IImprovementReportExportViewModel[] = [
  {
    id: 1,
