...
import {
  ...
  ITrackSelfAssessmentProgressCurrentSituationRowHistoryProofDetail,
  ITrackSelfAssessmentProgressCurrentSituationRowProofLocal,
} from "./interface";
import MyButtonViewPDF from "@/components/Buttons/ButtonViewPDF/MyButtonViewPDF";

export default function TrackSelfAssessmentProgressCurrentSituationDetail({
  data,
}: {
  data: ITrackSelfAssessmentProgressCurrentSituationRowHistoryProof;
}) {
  ...
  const columns = useMemo<
    MRT_ColumnDef<ITrackSelfAssessmentProgressCurrentSituationRowHistoryProofDetail>[]
  >(
    () => [
      {
        header: "ID file",
  ...
  const columnsLocal = useMemo<
    MRT_ColumnDef<ITrackSelfAssessmentProgressCurrentSituationRowProofLocal>[]
  >(
    () => [
      {
...
const mockDataProof: ITrackSelfAssessmentProgressCurrentSituationRowHistoryProofDetail[] = [
  {
    id: 1,
    fileId: "FILE_ID_0001",
...
const mockDataLocal: ITrackSelfAssessmentProgressCurrentSituationRowProofLocal[] = [
  {
    id: 1,
