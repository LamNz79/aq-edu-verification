...
import TrackSelfAssessmentProgressStrengthsRow from "./TrackSelfAssessmentProgressStrengthsRow";
import { ITrackSelfAssessmentProgressStrengthsRowHistory } from "./interface";

export default function TrackSelfAssessmentProgressStrengthsLayout() {
  return (
    <MyFlexColumn gap={4}>
      <Stack gap={2}>
        <Text size="md" fw={500}>
...
const mockData: ITrackSelfAssessmentProgressStrengthsRowHistory[] = [
  {
    id: "1",
